<template>
    ...
    <div>
        <el-container>
            <el-header>
                <div style="color: rgb(100,100,100); text-align: left; height: 109px; margin-left: 5px;">
                    <h2>{{ title }}</h2>
                    <div>
                        <el-button type="primary-3rd" @click="remove1">
                            <el-tooltip offset="17" class="box-item" effect="dark" hide-after="0" content="删除"
                                placement="bottom">
                                <el-icon class="el-icon--center">
                                    <img style="width: 30px;" src="https://f005.backblazeb2.com/file/img-forWeb/uPic/Close.png">
                                </el-icon>
                            </el-tooltip>
                        </el-button>
                    </div>
...
const scan = () => {
    refresh.value = false
    axios.get('/file/scan?id=' + localStorage.getItem("id"))
        .then(res => {
